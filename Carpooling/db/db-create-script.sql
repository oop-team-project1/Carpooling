...
(
    ...
    unique (phone_number),
    constraint users_pk4 unique (phone_number),
...
(
    ...
    constraint coordinates_cities_city_id_fk
...
(
    ...
    created_at       date                                  not null,
    constraint trips_coordinates_coordinate_id_fk
        foreign key (start_point) references coordinates (coordinate_id),
    constraint trips_coordinates_coordinate_id_fk2
